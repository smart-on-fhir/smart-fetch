...
async def finish_wrapper(
    ...
    *,
    ...
    elif res_type not in filters.since_resources():
        # If we aren't doing an incremental update, record all the deleted resources since the last
        # time we did a full update
