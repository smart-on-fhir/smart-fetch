...
class BulkTests(utils.TestCase):
    ...
    async def test_since_created(self):
        ...
        filters = [
            ...
            f"{resources.FAMILY_MEMBER_HISTORY}?date=gt2022-01-05",
            ...
            f"{resources.QUESTIONNARE}?date=gt2022-01-05",
        ...
        self.assert_folder(
            {
                ".metadata": {
                    ...
                    "done": {
                        ...
                        "CarePlan": utils.TRANSACTION_TIME,
                        ...
                        "FamilyMemberHistory": utils.TRANSACTION_TIME,
                        "Immunization": utils.TRANSACTION_TIME,
                        "MedicationAdministration": utils.TRANSACTION_TIME,
                        ...
                        "Questionnare": utils.TRANSACTION_TIME,
                        "ResearchSubject": utils.TRANSACTION_TIME,
