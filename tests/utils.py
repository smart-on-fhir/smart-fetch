            ...
            "rest": [
                {
                    ...
                    "resource": [
                        ...
                        {"type": resources.CARE_PLAN},
                        {
                            "type": resources.FAMILY_MEMBER_HISTORY,
                            "searchParam": [{"name": "date"}],
                        },
                        {"type": resources.MEDICATION_ADMINISTRATION},
                        {"type": resources.QUESTIONNARE, "searchParam": [{"name": "date"}]},
                        {"type": resources.RESEARCH_SUBJECT},
                    ],
                },
            ],
        }
